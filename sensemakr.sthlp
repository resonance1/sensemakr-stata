...
{p 4 8 2}{stata "use darfur.dta, clear":. use darfur.dta, clear}{p_end}
    ...
    Basic syntax
{p 4 8 2}sensemakr peacefactor directlyharmed age farmer_dar herder_dar ///{p_end}
{p 4 8 2}pastvoted hhsize_darfur female i.village_factor, treat(directlyharmed) benchmark(female){p_end}

    Basic graphing
{p 4 8 2}sensemakr peacefactor directlyharmed age farmer_dar herder_dar ///{p_end}
{p 4 8 2}pastvoted hhsize_darfur female i.village_factor, treat(directlyharmed) benchmark(female) ///{p_end}
{p 4 8 2}contourplot tcontourplot extremeplot{p_end}

    Combining individual and grouped benchmarks
{p 4 8 2}sensemakr peacefactor directlyharmed age farmer_dar herder_dar ///{p_end}
{p 4 8 2}pastvoted hhsize_darfur female i.village_factor, treat(directlyharmed) benchmark(female) ///{p_end}
{p 4 8 2}gbenchmark(age farmer_dar herder_dar pastvoted hhsize_darfur female) gname(all) {p_end}

    Altering default bounds
{p 4 8 2}sensemakr peacefactor directlyharmed age farmer_dar herder_dar ///{p_end}
{p 4 8 2}pastvoted hhsize_darfur female i.village_factor, treat(directlyharmed) benchmark(female) ///{p_end}
{p 4 8 2}kd(4 5) ky(3 3){p_end}

    Altering assumptions
{p 4 8 2}sensemakr peacefactor directlyharmed age farmer_dar herder_dar ///{p_end}
{p 4 8 2}pastvoted hhsize_darfur female i.village_factor, treat(directlyharmed) benchmark(female) ///{p_end}
{p 4 8 2}q(2) noreduce{p_end}{p_end}
